...
\bibitem{controller_manager} \textit{Controller Manager} \url{http://wiki.ros.org/controller_manager}.

\bibitem{viscosity} \textit{Viscosity} \url{https://github.com/andreastocco01/ur5_ft_tasks/blob/main/src/viscosity.cpp}. 

\bibitem{force_follower} \textit{Force Follower} \url{https://github.com/andreastocco01/ur5_ft_tasks/blob/main/src/velocity_force_follower.cpp}.

\bibitem{placement} \textit{Placement} \url{https://github.com/andreastocco01/ur5_ft_tasks/blob/main/src/placement.cpp}.

\bibitem{insertion} \textit{Insertion} \url{https://github.com/andreastocco01/ur5_ft_tasks/blob/main/scripts/place_ontop.py}.

\bibitem{spiral} \textit{Spiral movement} \url{https://github.com/andreastocco01/ur5_ft_tasks/blob/main/src/spiral_movement.cpp}. 

\bibitem{full_force_follower} \textit{Full force follower} \url{https://github.com/andreastocco01/ur5_ft_tasks/blob/main/src/full_velocity_force_follower.cpp}.
