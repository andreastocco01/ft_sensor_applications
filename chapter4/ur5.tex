...
\begin{figure}[H]
    ...
    \label{fig:payload}
\end{figure}
Come si pu\`{o} notare in Figura \ref{fig:payload}, l'UR5 \`{e} in grado di sopportare un carico massimo di $5 \, \text{kg}$ finch\`{e} 
l'estensione del braccio non supera i $350 \, \text{mm}$. Da qui in poi al crescere dell'offset seguir\`{a} una diminuzione del carico massimo 
applicabile.
